...
const Header2 = (props) => {
  return (
    <div className={`header2-container ${props.rootClassName} `}>
      <header data-role="Header" className="header2-header">
        <div className="header2-container1">
          <Link to="/" className="header2-text">
            <span className="header2-text1">
              <span
            ...
            <span className="header2-text2">Vitality</span>
            <span className="header2-text3">Roots</span>
          </Link>
        </div>
        ...
        <div data-role="MobileMenu" className="header2-mobile-menu">
          <div className="header2-nav">
            <div className="header2-container3">
              ...
              />
              <div data-role="CloseMobileMenu" className="header2-menu-close">
                <svg viewBox="0 0 1024 1024" className="header2-icon04">
                  <path
