...
import './community-post-2.css'

const CommunityPost2 = (props) => {
  return (
    <div className={`community-post-2-container ${props.rootClassName} `}>
      <div className="community-post-2-container1">
        <svg viewBox="0 0 1024 1024" className="community-post-2-icon">
          <path
        ...
        <span className="community-post-2-text">{props.text}</span>
        <button type="button" className="community-post-2-button button">
          {props.button}
        </button>
      </div>
      <div className="community-post-2-container2">
        <h1 className="community-post-2-text1">{props.heading}</h1>
        <span className="community-post-2-text2">{props.text1}</span>
        <div className="community-post-2-container3">
          <svg viewBox="0 0 1024 1024" className="community-post-2-icon2">
            <path
          ...
          <svg viewBox="0 0 1024 1024" className="community-post-2-icon4">
            <path
          ...
          <svg
            ...
            className="community-post-2-icon6"
          >
            <path
        ...
        <div className="community-post-2-container4">
          <div className="community-post-2-container5"></div>
        </div>
      </div>
    </div>
  )
